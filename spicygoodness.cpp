...
cout<<"daca ai doar meioze apasa 1;    daca ai o mitoza apasa 2;      daca ai niste mitoze si o meioza apasa 3 ____";//meioze si mitoze, apasa 4
cin>>dorinta;
int nrmame, nrfiice;
...
if(dorinta==2)
    {
cout<<"cate meioze?(momentan merge la doar o mitoza)";cin>>nrmeioze;
...
if(dorinta==3)
    {
        cout<<"nu este gata inca, dar puteti folosi  programul de 2 ori apasand 1 si 2 la inceput";
            }
return 0;}
